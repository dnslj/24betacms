...
-- ----- 升级 ------
INSERT INTO `cd_config` VALUES ('32', '11', 'user_required_admin_verfiy', '1', '0', '用户注册是否需要管理员审核', '用户注册是否需要管理审核'), ('33', '11', 'user_required_email_verfiy', '0', '0', '用户注册是否需要邮件审核', '用户注册是否需要邮件审核');
-- -------------
