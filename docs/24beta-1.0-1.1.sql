...
INSERT INTO `cd_config` VALUES ('', '11', 'user_required_admin_verfiy', '1', '0', '用户注册是否需要管理员审核', '用户注册是否需要管理审核'), ('', '11', 'user_required_email_verfiy', '0', '0', '用户注册是否需要邮件审核', '用户注册是否需要邮件审核'), ('', '22', 'post_list_type', '0', '0', '分类文章列表方式', '0 为跟首页一样显示概述\r\n1 为标题列表方式');
